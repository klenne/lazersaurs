...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Username   = 'tinyduckcorp@gmail.com';   //SEU USUÁRIO DE EMAIL
    $mail->Password   = 'tinyduck123';                   //SUA SENHA DO EMAIL SMTP password
    ...
    //Recipients
    $mail->setFrom('tinyduckcorp@gmail.com', 'Site');  //DEVE SER O MESMO EMAIL DO USERNAME
    $mail->addAddress('tinyduckcorp@gmail.com');     // QUAL EMAIL RECEBERÁ A MENSAGEM!
    ...
    $mail->Subject = 'Mensagem do Formulário do site Lazersaur'; //ASSUNTO
